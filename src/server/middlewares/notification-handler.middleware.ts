...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'user.update': {
    roles: ['clinic-owner'],
    key: 'doctor-profile-updated',
    tenantPath: ['clinic', 'user'],
    userPath: [],
  },
  'user.delete': {
    roles: ['clinic-owner'],
    key: 'nurse-profile-deleted',
    tenantPath: ['clinic', 'user'],
    userPath: [],
  },
  'pet.create': {
    roles: ['veterinarian', 'veterinary-nurse'],
    key: 'new-pet-profile',
    tenantPath: ['clinic', 'user', 'customer', 'pet'],
    userPath: [],
  },
  'exam.update': { roles: ['veterinarian', 'veterinary-nurse'], key: 'pet-exam-updated', tenantPath: [], userPath: [] },
  'appointment.delete': {
    roles: ['veterinarian', 'veterinary-nurse'],
...
const tenantRoles: string[] = ['clinic-owner', 'veterinarian', 'veterinary-nurse'];
