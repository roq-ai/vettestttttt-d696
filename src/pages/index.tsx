...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`vettestttttt`}</title>

        <meta
          name="description"
          content="Welcome to vettestttttt: Your complete solution for vet clinic management. Streamline customer and pet profiles, note-taking, file uploads, and much more for seamless operational efficiency."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1551076805-e1869033e561?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHx2ZXQlMjBjbGluaWN8ZW58MHx8fHwxNjk1MDU3NjIzfDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@tetrakiss?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`Arseny Togulev`}</Link>{' '}
              on{' '}
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to vettestttttt: Your complete solution for vet clinic management. Streamline customer and pet profiles, note-taking, file uploads, and much more for seamless operational efficiency.`}
            </Text>
            <Box
            ...
            >
              <Stack direction={{ md: 'row', base: 'column' }} spacing="1.5rem">
                <Card userTypeName="Clinic Owner" type="clinic-owner" abilities={appConfig.ownerAbilities} />
              </Stack>
            </Box>
          </Box>
          <Box pt={4}>
