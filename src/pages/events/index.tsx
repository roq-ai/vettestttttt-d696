...
type ColumnType = ColumnDef<EventInterface, unknown>;
...
export function EventListPage(props: EventListPageProps) {
  ...
  const { data, error, isLoading, mutate } = useSWR<PaginatedInterface<EventInterface>>(
