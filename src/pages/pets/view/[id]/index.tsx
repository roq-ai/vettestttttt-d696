            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('pet', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/pets/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              >
                ...
                <FormListItem label="Species" text={data?.species} />

                <FormListItem label="Breed" text={data?.breed} />

                <FormListItem label="Age" text={data?.age} />

                <FormListItem label="Weight" text={data?.weight} />
