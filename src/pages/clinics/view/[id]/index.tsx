...
import { getClinicById } from 'apiSdk/clinics';
import { ClinicInterface } from 'interfaces/clinic';

function ClinicViewPage() {
            ...
            <FormWrapper wrapperProps={{ gap: 3, p: 4 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('clinic', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/clinics/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              <EntityImage entity="clinic" entityId={id} />
              <List
                w="100%"
                css={{
                  '> li:not(:last-child)': {
